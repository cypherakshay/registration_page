...
## **Registration Page** - Mobile Responsive `(static page)`
...
This project is a registration page that contains a form for create a user account. In this project, I learned to create a form with HTML & CSS. I also learned to use creativity with code and some basics of CSS and also media queries property of CSS, which makes the task very easier.
 

&nbsp;

I write the code with the proper comments to understand its reference easily to the other coder and also this page is mobile responsive, In which I learn how to write media queries for different types of screen sizes. 
&nbsp;
...
![Project Snapshot](./images/registrationpage-thumbnail.png)
...
[<img alt="Go Live" width="170px" src="https://user-images.githubusercontent.com/110058268/192381169-8441c110-50f4-43a0-9ab1-b4cd6c509f95.png" />](https://cypherakshay-registration-page.netlify.app/ "Go Live")
